...
if(!isset($_POST['login'])&&(!isset($_POST['password']))) {
    ...
    session_start();
        ...
        header("Location: ".PATH."/knowledge_base/admin/admin.php");
    } else {
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-center">
                <li class="active"><a href="http://localhost/bitbridge/knowledge_base/courseTitle.php?title_id=1">HTML</a></li>
                ...
                <li><a href="<?php echo PATH;?>/knowledge_base/courseTitle.php?title_id=5">jQuery</a></li>
            </ul>
        </div>
    </div>
</nav>
